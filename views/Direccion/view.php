...
<div class="container py-5">
    ...
    <div class="direccion-view bg-light shadow-lg rounded p-5" style="max-width: 700px; width: 100%; border-radius: 15px;">
        
        <h1 class="text-center text-primary font-weight-bold mb-4"><?= Html::encode($this->title) ?></h1>

        <p class="text-center">
            <?php if (Yii::$app->user->identity->role == 'admin'): ?>
                <?= Html::a(Yii::t('app', 'Actualizar'), ['update', 'iddireccion' => $model->iddireccion, 'persona_idpersona' => $model->persona_idpersona], ['class' => 'btn btn-primary px-4 py-2']) ?>
                <?= Html::a(Yii::t('app', 'Eliminar'), ['delete', 'iddireccion' => $model->iddireccion, 'persona_idpersona' => $model->persona_idpersona], [
